...
from .views import get_events, get_event_actions, ticket_form_view, delete_ticket_view, get_ticket_view

app_name = 'events'
urlpatterns = [
    # Patient CRUD urls
    path(r'events-for-user', get_events, name='events-for-user'),
    path(r'actions-for-event/<int:event_id>/', get_event_actions, name='actions-for-event'),
